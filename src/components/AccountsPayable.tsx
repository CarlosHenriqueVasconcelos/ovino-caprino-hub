...
export default function AccountsPayable({ onUpdate }: AccountsPayableProps) {
  ...
  const loadAccounts = () => {
    ...
    setAccounts(allAccounts.filter(a => a.type === 'despesa').sort((a, b) => a.due_date.localeCompare(b.due_date)));
    onUpdate?.();
  };
