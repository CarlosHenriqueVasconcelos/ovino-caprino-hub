...
class AnimalRepository {
  ...
  AnimalRepository(this._db) : _readQueries = AnimalRepositoryReadQueries(_db);
  ...
  Future<List<String>> getDistinctColors() {
    return _readQueries.getDistinctColors();
  }

  Future<List<String>> getDistinctCategories() {
    return _readQueries.getDistinctCategories();
  }
