#define MyAppName "Fazenda São Petrônio"
#define MyCompany "BEGO Agritech"
...
[Run]
Filename: "{app}\{#MyAppExeName}"; Description: "Executar Fazenda São Petrônio"; Flags: nowait postinstall skipifsilent
